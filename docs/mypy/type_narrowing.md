...
:::{note}
Narrowing is
[not strict](https://www.python.org/dev/peps/pep-0647/#enforcing-strict-narrowing).
...
:::{note}
Note, that `TypeGuard`
[does not narrow](https://www.python.org/dev/peps/pep-0647/#narrowing-of-implicit-self-and-cls-parameters)
